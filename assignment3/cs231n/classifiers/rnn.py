...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # calculate gradients
        dout, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dloss, affine_cache)
        if self.cell_type == 'rnn':
            dx, dh0, grads['Wx'], grads['Wh'], grads['b'] = rnn_backward(dout, rnn_cache)
        else:
            dx, dh0, grads['Wx'], grads['Wh'], grads['b'] = lstm_backward(dout, lstm_cache)
